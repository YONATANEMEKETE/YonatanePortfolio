...
const Projects = () => {
  return (
    <section
      id="projects"
      className="w-full  overflow-hidden max-w-[1540px] mx-auto h-max min-[1500px]:h-[60vw] pt-40  px-4 md:px-12 lg:px-20 xl:px-36 space-y-20"
    >
      <p className="text-3xl md:text-5xl lg:text-5xl text-center  text-text font-header font-bold">
